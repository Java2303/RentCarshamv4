...
namespace RentCarsham.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(RentCarshamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Nombre,Pais")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Nombre,Pais")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
